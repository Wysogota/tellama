...
FORMAT: Keep your responses natural, concise, and conversational — typically 1-2 sentences, the way real people actually text on their phones. Do NOT use markdown formatting (no headers, no bullet points, no bold/italic).`.trim();
};
